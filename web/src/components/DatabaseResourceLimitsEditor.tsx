...
// layout. The one real difference is the submit path: apps go through
// useUpdateApp's general PUT /apps/{name}, databases through the
// dedicated useSetDatabaseResources (PUT /databases/{name}/resources),
// since there is no PUT /databases/{name} to fold this into.
