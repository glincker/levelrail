...
// active concurrent development elsewhere in this repo right now, and
// extracting a shared migration package would mean editing it too, for
// what's currently a single embedded-migrations-directory difference.
// Worth revisiting as a real shared package once both stabilize.
