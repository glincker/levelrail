...
const file_proto_agent_v1_agent_proto_rawDesc = "" +
	...
	"\fbuild_credit\x18\a \x01(\v2\x1f.levelrail.agent.v1.BuildCreditH\x00R\vbuildCreditB\t\n" +
	"\apayload\"\x84\t\n" +
...
var file_proto_agent_v1_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_proto_agent_v1_agent_proto_goTypes = []any{
	...
	(*ExecInput)(nil),                    // 35: levelrail.agent.v1.ExecInput
	(*ExecCancel)(nil),                   // 36: levelrail.agent.v1.ExecCancel
	(*ExecCredit)(nil),                   // 37: levelrail.agent.v1.ExecCredit
	(*ExecOutput)(nil),                   // 38: levelrail.agent.v1.ExecOutput
	(*ExecFailure)(nil),                  // 39: levelrail.agent.v1.ExecFailure
	(*ExecExit)(nil),                     // 40: levelrail.agent.v1.ExecExit
	(*BuildRequest)(nil),                 // 41: levelrail.agent.v1.BuildRequest
	(*BuildCache)(nil),                   // 42: levelrail.agent.v1.BuildCache
	(*BuildInput)(nil),                   // 43: levelrail.agent.v1.BuildInput
	(*BuildCancel)(nil),                  // 44: levelrail.agent.v1.BuildCancel
	(*BuildCredit)(nil),                  // 45: levelrail.agent.v1.BuildCredit
	(*BuildOutput)(nil),                  // 46: levelrail.agent.v1.BuildOutput
	(*BuildProgress)(nil),                // 47: levelrail.agent.v1.BuildProgress
	(*BuildDone)(nil),                    // 48: levelrail.agent.v1.BuildDone
	(*BuildFailure)(nil),                 // 49: levelrail.agent.v1.BuildFailure
	(*WatchEventsRequest)(nil),           // 50: levelrail.agent.v1.WatchEventsRequest
	nil,                                  // 51: levelrail.agent.v1.ContainerSpec.EnvEntry
	nil,                                  // 52: levelrail.agent.v1.BuildRequest.BuildArgsEntry
	nil,                                  // 53: levelrail.agent.v1.BuildDone.ExporterResponseEntry
...
var file_proto_agent_v1_agent_proto_depIdxs = []int32{
	...
	38, // 2: levelrail.agent.v1.AgentMessage.exec_output:type_name -> levelrail.agent.v1.ExecOutput
	37, // 3: levelrail.agent.v1.AgentMessage.exec_credit:type_name -> levelrail.agent.v1.ExecCredit
	46, // 4: levelrail.agent.v1.AgentMessage.build_output:type_name -> levelrail.agent.v1.BuildOutput
	45, // 5: levelrail.agent.v1.AgentMessage.build_credit:type_name -> levelrail.agent.v1.BuildCredit
	5,  // 6: levelrail.agent.v1.ControlMessage.request:type_name -> levelrail.agent.v1.AgentRequest
	35, // 7: levelrail.agent.v1.ControlMessage.exec_input:type_name -> levelrail.agent.v1.ExecInput
	36, // 8: levelrail.agent.v1.ControlMessage.exec_cancel:type_name -> levelrail.agent.v1.ExecCancel
	37, // 9: levelrail.agent.v1.ControlMessage.exec_credit:type_name -> levelrail.agent.v1.ExecCredit
	43, // 10: levelrail.agent.v1.ControlMessage.build_input:type_name -> levelrail.agent.v1.BuildInput
	44, // 11: levelrail.agent.v1.ControlMessage.build_cancel:type_name -> levelrail.agent.v1.BuildCancel
	45, // 12: levelrail.agent.v1.ControlMessage.build_credit:type_name -> levelrail.agent.v1.BuildCredit
	15, // 13: levelrail.agent.v1.AgentRequest.inspect_by_name:type_name -> levelrail.agent.v1.InspectByNameRequest
	17, // 14: levelrail.agent.v1.AgentRequest.create:type_name -> levelrail.agent.v1.CreateRequest
	19, // 15: levelrail.agent.v1.AgentRequest.start:type_name -> levelrail.agent.v1.StartRequest
	20, // 16: levelrail.agent.v1.AgentRequest.stop:type_name -> levelrail.agent.v1.StopRequest
	21, // 17: levelrail.agent.v1.AgentRequest.remove:type_name -> levelrail.agent.v1.RemoveRequest
	23, // 18: levelrail.agent.v1.AgentRequest.list_images:type_name -> levelrail.agent.v1.ListImagesRequest
	25, // 19: levelrail.agent.v1.AgentRequest.list_by_prefix:type_name -> levelrail.agent.v1.ListByPrefixRequest
	27, // 20: levelrail.agent.v1.AgentRequest.ensure_volume:type_name -> levelrail.agent.v1.EnsureVolumeRequest
	50, // 21: levelrail.agent.v1.AgentRequest.watch_events:type_name -> levelrail.agent.v1.WatchEventsRequest
	22, // 22: levelrail.agent.v1.AgentRequest.update_resources:type_name -> levelrail.agent.v1.UpdateResourcesRequest
	29, // 23: levelrail.agent.v1.AgentRequest.ensure_network:type_name -> levelrail.agent.v1.EnsureNetworkRequest
	31, // 24: levelrail.agent.v1.AgentRequest.remove_network:type_name -> levelrail.agent.v1.RemoveNetworkRequest
	32, // 25: levelrail.agent.v1.AgentRequest.list_networks_by_prefix:type_name -> levelrail.agent.v1.ListNetworksByPrefixRequest
	34, // 26: levelrail.agent.v1.AgentRequest.exec:type_name -> levelrail.agent.v1.ExecRequest
	41, // 27: levelrail.agent.v1.AgentRequest.build:type_name -> levelrail.agent.v1.BuildRequest
	16, // 28: levelrail.agent.v1.AgentResponse.inspect_by_name:type_name -> levelrail.agent.v1.InspectByNameResponse
	18, // 29: levelrail.agent.v1.AgentResponse.create:type_name -> levelrail.agent.v1.CreateResponse
	24, // 30: levelrail.agent.v1.AgentResponse.list_images:type_name -> levelrail.agent.v1.ListImagesResponse
	26, // 31: levelrail.agent.v1.AgentResponse.list_by_prefix:type_name -> levelrail.agent.v1.ListByPrefixResponse
	7,  // 32: levelrail.agent.v1.AgentResponse.empty:type_name -> levelrail.agent.v1.Empty
	30, // 33: levelrail.agent.v1.AgentResponse.ensure_network:type_name -> levelrail.agent.v1.EnsureNetworkResponse
	33, // 34: levelrail.agent.v1.AgentResponse.list_networks_by_prefix:type_name -> levelrail.agent.v1.ListNetworksByPrefixResponse
	8,  // 35: levelrail.agent.v1.ContainerSpec.ports:type_name -> levelrail.agent.v1.PortBinding
	51, // 36: levelrail.agent.v1.ContainerSpec.env:type_name -> levelrail.agent.v1.ContainerSpec.EnvEntry
	9,  // 37: levelrail.agent.v1.ContainerSpec.resources:type_name -> levelrail.agent.v1.Resources
	10, // 38: levelrail.agent.v1.ContainerSpec.volumes:type_name -> levelrail.agent.v1.VolumeMount
	8,  // 39: levelrail.agent.v1.ContainerState.ports:type_name -> levelrail.agent.v1.PortBinding
	54, // 40: levelrail.agent.v1.ImageInfo.created_at:type_name -> google.protobuf.Timestamp
	54, // 41: levelrail.agent.v1.ProxiedEvent.time:type_name -> google.protobuf.Timestamp
	12, // 42: levelrail.agent.v1.InspectByNameResponse.state:type_name -> levelrail.agent.v1.ContainerState
	11, // 43: levelrail.agent.v1.CreateRequest.spec:type_name -> levelrail.agent.v1.ContainerSpec
	9,  // 44: levelrail.agent.v1.UpdateResourcesRequest.resources:type_name -> levelrail.agent.v1.Resources
	13, // 45: levelrail.agent.v1.ListImagesResponse.images:type_name -> levelrail.agent.v1.ImageInfo
	12, // 46: levelrail.agent.v1.ListByPrefixResponse.containers:type_name -> levelrail.agent.v1.ContainerState
	28, // 47: levelrail.agent.v1.ListNetworksByPrefixResponse.networks:type_name -> levelrail.agent.v1.NetworkInfo
	39, // 48: levelrail.agent.v1.ExecOutput.failure:type_name -> levelrail.agent.v1.ExecFailure
	40, // 49: levelrail.agent.v1.ExecFailure.exit:type_name -> levelrail.agent.v1.ExecExit
	0,  // 50: levelrail.agent.v1.BuildRequest.kind:type_name -> levelrail.agent.v1.BuildKind
	52, // 51: levelrail.agent.v1.BuildRequest.build_args:type_name -> levelrail.agent.v1.BuildRequest.BuildArgsEntry
	42, // 52: levelrail.agent.v1.BuildRequest.cache:type_name -> levelrail.agent.v1.BuildCache
	47, // 53: levelrail.agent.v1.BuildOutput.progress:type_name -> levelrail.agent.v1.BuildProgress
	48, // 54: levelrail.agent.v1.BuildOutput.done:type_name -> levelrail.agent.v1.BuildDone
	49, // 55: levelrail.agent.v1.BuildOutput.failure:type_name -> levelrail.agent.v1.BuildFailure
	53, // 56: levelrail.agent.v1.BuildDone.exporter_response:type_name -> levelrail.agent.v1.BuildDone.ExporterResponseEntry
	1,  // 57: levelrail.agent.v1.AgentService.Enroll:input_type -> levelrail.agent.v1.EnrollRequest
	3,  // 58: levelrail.agent.v1.AgentService.Session:input_type -> levelrail.agent.v1.AgentMessage
	2,  // 59: levelrail.agent.v1.AgentService.Enroll:output_type -> levelrail.agent.v1.EnrollResponse
	4,  // 60: levelrail.agent.v1.AgentService.Session:output_type -> levelrail.agent.v1.ControlMessage
...
func file_proto_agent_v1_agent_proto_init() {
	...
	file_proto_agent_v1_agent_proto_msgTypes[45].OneofWrappers = []any{
