...
// Scheduled task run statuses migrations/0048_scheduled_tasks.sql's CHECK
...
// migrations/0048_scheduled_tasks.sql's own doc comment for why.
...
// migrations/0048's ON DELETE CASCADE, every scheduled_task_runs row
...
// (migrations/0048's own index is built for exactly this query shape).
