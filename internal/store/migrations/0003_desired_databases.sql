...
-- storage the secrets design specifies, which doesn't exist yet.
-- Adding a plaintext password column now, even as a marked
-- "temporary" stopgap, is exactly the kind of security shortcut this
-- project's own standards rule out. The database controller
