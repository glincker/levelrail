...
func (rt *Router) requireApp(w http.ResponseWriter, r *http.Request, name string) (*store.DesiredService, bool) {
...
func (rt *Router) handleGetLoadBalancer(w http.ResponseWriter, r *http.Request) {
	...
	if _, ok := rt.requireApp(w, r, name); !ok {
		return
	}
