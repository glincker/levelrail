...
`,
			...
			wantUnresolved: []UnresolvedVar{{Service: "app", EnvKey: "command[2]", Token: "${SERVICE_FQDN_APP}"}}, //nolint:gosec // template token in a test fixture, not a credential
		},
	}
