...
395 registered routes total (see [api-reference.md](api-reference.md) for
...
- [API reference](api-reference.md) - Method/path/ability listing for the API routes (all 395 registered routes in `routes.go` and `routes_platform.go`, generated by `go run ./scripts/gen-api-reference`)
