...
func TestRun_AppsOrganizationsEnvGet(t *testing.T) {
	testEnvGet(t, []string{"apps", "organizations"}, "org_1", "/api/v1/organizations/org_1")
}

func TestRun_AppsOrganizationsEnvGet_NoneSet(t *testing.T) {
	testEnvGetNoneSet(t, []string{"apps", "organizations"}, "org_1")
}

func TestRun_AppsOrganizationsEnvSet(t *testing.T) {
	testEnvSet(t, []string{"apps", "organizations"}, "org_1", "/api/v1/organizations/org_1", "organization")
}

func TestRun_AppsOrganizationsEnvSet_NoVars_ClearsAll(t *testing.T) {
	testEnvSetClearsAll(t, []string{"apps", "organizations"}, "org_1", "organization")
}
