...
func runRegistryCredentialsList(prog string, args []string, stdout, stderr io.Writer, lookupEnv func(string) (string, bool)) int {
	fs, tokenFlagP, apiURLFlagP, jsonOutP := apiFlagSet(prog, "registry-credentials list", "print registry credentials as a JSON array to stdout and nothing else", stderr)
