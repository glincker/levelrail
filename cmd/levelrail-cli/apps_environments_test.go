...
func TestRun_AppsEnvironmentsEnvGet(t *testing.T) {
	testEnvGet(t, []string{"apps", "environments"}, "env_1", "/api/v1/environments/env_1")
}

func TestRun_AppsEnvironmentsEnvGet_NoneSet(t *testing.T) {
	testEnvGetNoneSet(t, []string{"apps", "environments"}, "env_1")
}

func TestRun_AppsEnvironmentsEnvSet(t *testing.T) {
	testEnvSet(t, []string{"apps", "environments"}, "env_1", "/api/v1/environments/env_1", "environment")
}
