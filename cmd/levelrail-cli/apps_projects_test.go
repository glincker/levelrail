...
func TestRun_AppsProjectsEnvGet_NoneSet(t *testing.T) {
	testEnvGetNoneSet(t, []string{"apps", "projects"}, "proj_1")
}

func TestRun_AppsProjectsEnvSet(t *testing.T) {
	testEnvSet(t, []string{"apps", "projects"}, "proj_1", "/api/v1/projects/proj_1", "project")
}

func TestRun_AppsProjectsEnvSet_NoVars_ClearsAll(t *testing.T) {
	testEnvSetClearsAll(t, []string{"apps", "projects"}, "proj_1", "project")
}
