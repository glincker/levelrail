...
var cliCommandTree = map[string]*cmdNode{
	"apps": {subs: map[string]*cmdNode{
		...
		"environments":       {subs: map[string]*cmdNode{"create": nil, "list": nil, "delete": nil, "env-get": nil, "env-set": nil}},
		"set-environment":    nil,
	...
	"backups": {subs: map[string]*cmdNode{
		"list": nil, "trigger": nil, "restore": nil,
	...
	"registry-credentials": {subs: map[string]*cmdNode{"list": nil, "get": nil, "create": nil, "update": nil, "delete": nil}},
