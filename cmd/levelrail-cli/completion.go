...
var cliCommandTree = map[string]*cmdNode{
	...
	"databases": {subs: map[string]*cmdNode{"create": nil, "list": nil, "get": nil, "delete": nil, "watch": nil, "resource-recommendation": nil, "set-project": nil, "clear-project": nil}},
	...
	"registry":             {subs: map[string]*cmdNode{"status": nil, "enable": nil, "disable": nil}},
