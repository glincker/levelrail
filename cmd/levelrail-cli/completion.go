...
var cliCommandTree = map[string]*cmdNode{
	...
	"databases": {subs: map[string]*cmdNode{"create": nil, "list": nil, "get": nil, "delete": nil, "credentials": nil, "resource-recommendation": nil, "set-project": nil, "clear-project": nil}},
